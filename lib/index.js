...
x = canvas.width;
for (var i = 0; i < 2; i++) {
  carArrayLeft.push(new Obstacle(x, 220, 30, 30, 'images/bubble-pile.svg'));
  x += 150;
}

x = 0;
for (var i = 0; i < 2; i++) {
  carArrayRight.push(new Obstacle(x, 185, 30, 30, 'images/wand.svg'));
  x += 150;
}

x = canvas.width;
for (var i = 0; i < 2; i++) {
  carArrayLeft.push(new Obstacle(x, 150, 30, 30, 'images/bubble-pile.svg'));
  x += 150;
}

x = 0;
for (var i = 0; i < 2; i++) {
  carArrayRight.push(new Obstacle(x, 115, 30, 30, 'images/wand.svg'));
  x += 150;
}
