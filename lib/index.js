...
requestAnimationFrame(function gameLoop(){
  ...
  cars.forEach(function(car){
    car.drawObstacle(canvas, context);
  })
...
function buildRoad1(){
  let r1yCoord = 375;
  let r1CarLength = squareWidth * 3;
  let r1Gap = squareWidth * 2;
  let r1Speed = 2;
  let r1NumberOfCars = 4;
  let r1offset = squareWidth * 2
  let buildRoad1Array = [];
  for(let i=0; i < r1NumberOfCars; i++){
    buildRoad1Array.push(new SlowCar((r1CarLength+r1Gap)*i, r1yCoord, r1CarLength, r1Speed, r1Gap, r1offset));
  }
