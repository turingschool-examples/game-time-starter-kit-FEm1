...
let newToad = new Toad(475, 325, 'safe', homes);
...
function collisionDetection() {
  ...
  //   if ((newToad.yCoord + 2 == log.yCoordinate) &&
  // ((newToad.xCoord - newToad.margin > log.xCoordinate &&
  //   newToad.xCoord + newToad.width + newToad.margin < log.xCoordinate + log.width))) {
  //     // debugger;
  //     newToad.velocity = log.velocity;
  //   }
  // })
  ...
  if (!toadLog.Length && newToad.yCoord < 325) {
    newToad.status = 'dead';
  }
}
