...
class Level {
  ...
  buildRoadLevel(level) {
    ...
    case 1:
      ...
      autos = autos.concat(this.buildRoadRow(SlowCar, 564.5, 1, 1, 4, 4, 4, 'pink'))
      autos = autos.concat(this.buildRoadRow(FastCar, 514.5, 1, 3, 3, 4, 1, 'red'));
      autos = autos.concat(this.buildRoadRow(Semi, 464.5, 2, -3, 3, 5, 3, 'orange'));
      break;
    case 2:
    ...
    case 3:
      ...
      autos = autos.concat(this.buildRoadRow(SlowCar, 564.5, 1, 1, 4, 4, 4, 'pink'))
      autos = autos.concat(this.buildRoadRow(FastCar, 514.5, 1, 15, 3, 2, 1, 'red'));
      autos = autos.concat(this.buildRoadRow(Semi, 464.5, 2, -3, 3, 5, 3, 'orange'));
      break;
    }
    return autos;
