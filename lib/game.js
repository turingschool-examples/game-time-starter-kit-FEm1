...
class Game {
  ...
  buildLevel() {
    this.autos = this.buildRoadRow(Tractor, 614.5, this.squareWidth, -2, this.squareWidth * 4, 4, this.squareWidth * 4, 'yellow');
    this.autos = this.autos.concat(this.buildRoadRow(SlowCar, 564.5, this.squareWidth * 2, 1, this.squareWidth * 5, 3, this.squareWidth * 4, 'pink'))
    this.autos = this.autos.concat(this.buildRoadRow(FastCar, 514.5, this.squareWidth * 2, 3, this.squareWidth * 3, 4, this.squareWidth * 3, 'red'));
    this.autos = this.autos.concat(this.buildRoadRow(Semi, 464.5, this.squareWidth * 5, -3, this.squareWidth * 3, 3, this.squareWidth * 4, 'orange'));
