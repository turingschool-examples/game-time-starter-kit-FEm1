...
class Obstacle {
  ...
  drawObstacle(canvas, context) {
    ...
    if(this.constructor.name == 'SlowCar') {
      context.drawImage(sprImage, slowCarImage.sourceX, slowCarImage.sourceY, slowCarImage.sourceWidth, slowCarImage.sourceHeight, this.xCoordinate, this.yCoordinate, this.width, this.height)
    } else if(this.constructor.name == 'FastCar') {
      context.drawImage(sprImage, fastCarImage.sourceX, fastCarImage.sourceY, fastCarImage.sourceWidth, fastCarImage.sourceHeight, this.xCoordinate, this.yCoordinate, this.width, this.height)
    } else if(this.constructor.name == 'Tractor') {
      context.drawImage(sprImage, tractorImage.sourceX, tractorImage.sourceY, tractorImage.sourceWidth, tractorImage.sourceHeight, this.xCoordinate, this.yCoordinate, this.width, this.height)
    } else if(this.constructor.name == 'Semi') {
      context.drawImage(sprImage, semiImage.sourceX, semiImage.sourceY, semiImage.sourceWidth, semiImage.sourceHeight, this.xCoordinate, this.yCoordinate, this.width, this.height)
    }
  }
  moveObstacle() {
